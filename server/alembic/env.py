...
Este backend é o único dono do schema (users, roles, kpi_*,
processed_emails) — o bot de extração não escreve mais direto no
Postgres, ele chama POST /api/ingestion/kpi-report. Por isso todos os
models entram aqui.
"""
