...
print(f"Baixando os 3 arquivos-fonte do Google Drive para {temp_dir}...")
...
print("\n🚀 Executando RawReportExtractor na pasta dos arquivos baixados...")
extractor = RawReportExtractor()
extraction = extractor.extract(temp_dir)
